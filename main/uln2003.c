...
void step(int dir)
{
    ...
    // TODO: Calc position and progress
    // StepperControl.position += RADIANS_PER_STEP * dir
    // StepperControl.progress = StepperControl.position / 3.1415f
}
...
static void periodic_timer_callback(void *arg)
{
    ...
    if (StepperControl.direction != 0)
        step(StepperControl.direction);

    // TODO: check if StepperControl.progress >= 100
}
